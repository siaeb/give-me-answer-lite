...
class GMA_Upload {
    ...
    function upload($file, $lang = 'en_GB') {
        ...
        $this->lang               = $lang;
        $upload_dir =dirname(__FILE__).'/localization';
        if ($this->lang != 'en_GB' && file_exists($upload_dir) && file_exists($upload_dir.'/class.upload.' . $lang . '.php')) {
            $translation = null;
            include( $upload_dir . '/class.upload.' . $lang . '.php');
