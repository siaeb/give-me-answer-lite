...
class GMA_Paginator {
	...
	public function toHtml()
	{
		...
		if ( $this->getPrevUrl() ) {
			$html .= '<li><a class="page-link" href="' . $this->getPrevUrl() . '">'. $this->previousText .'</a></li>';
		}

		foreach ($this->getPages() as $page) {
			$html .= '<li' . ($page['isCurrent'] ? ' class="active" ' : '') . '><a href="' . $page['url'] .'" data-page="' . $page['num'] .'" class="page page-link">' . $page['num'] . '</a></li>';
		}

		if ($this->getNextUrl()) {
			$html .= '<li><a class="page-link" href="' . $this->getNextUrl() . '">'. $this->nextText .' </a></li>';
		}
		$html .= '</ul>';
